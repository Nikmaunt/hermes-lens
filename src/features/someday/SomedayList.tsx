...
/**
 * The someday card list with its Activate/Close/Undo machinery — shared
 * verbatim between the Someday screen and the Someday section on Today, so
 * both surfaces drive the exact same mutations. Loading/error/empty framing
 * stays with the callers.
 */
export function SomedayList({ items }: { items: readonly SomedayItem[] }) {
