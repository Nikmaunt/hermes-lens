...
/*
 * Notification listener capture contract (web layer; the native service ships
 * next release). The two declarations below are a VERBATIM copy shared with
 * the sidecar, which keeps an identical mirror of this schema — any change
 * must land in both places or replays will be rejected.
 */
