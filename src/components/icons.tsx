...
/**
 * The app's single icon set: thin outlined strokes, no fills, currentColor.
 * Path data is copied from lucide (ISC licence) so there is no runtime
 * dependency — content emojis inside user text are unaffected.
 */
...
function makeIcon(children: ReactNode): IconComponent {
...
export const GraphIcon = makeIcon(
  <>
...
export const SquareCheckIcon = makeIcon(
  <>
...
export const MessageCircleIcon = makeIcon(<path d="M7.9 20A9 9 0 1 0 4 16.1L2 22Z" />)
...
export const WavesIcon = makeIcon(
  <>
